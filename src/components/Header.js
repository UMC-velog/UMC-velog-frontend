    ...
    return(
        <div className={["Header", type].join("")}>
            ...
            <div className="header_right">
                ...
                { loggedIn && <button className="btn_post">새 글 작성</button>}
                { loggedIn ? 
                <div className="header_image_profile" onClick={openUserMenu}>
                    ...
                    {isUserMenuOpen && <div className="HeaderUserMenu_block" ><div className="HeaderUserMenu_menu-wrapper" ><ul><li>내 벨로그</li><li>새 글 작성</li><li>임시 글</li><li>읽기 목록</li><li>설정</li><li>로그아웃</li></ul></div></div>}
                </div>                
                :
