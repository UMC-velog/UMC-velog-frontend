...
const SearchedItem = ({id, image, title, content, createdDate, commentsCount, writer, likeCount}) => {
    ...
    return(
        <div className="SearchedItem" onClick={(goPost)}>
